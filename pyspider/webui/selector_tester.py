...
# Note: The route for the selector_tester page is defined in index.py
# to avoid circular imports

def test_selector_handler():
...
# Only register the routes when this module is imported by __init__.py
# This prevents duplicate route registration when the module is run directly
if __name__ != '__main__':
    # Use unique endpoint names to avoid conflicts
    app.add_url_rule('/api/test_selector', 'selector_tester_test_selector', test_selector_handler, methods=['POST'])
    app.add_url_rule('/api/load_url', 'selector_tester_load_url', load_url_handler, methods=['POST'])
